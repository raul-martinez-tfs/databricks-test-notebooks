...
s3_bucket = 'tfsdl-edp-supplychain-prod'
# s3_bucket = 'tfsdl-edp-common-dims-prod'
...
buckets_list = list(set(([i['Name'] for i in s3_client.list_buckets()['Buckets']])))
print(buckets_list)

# COMMAND ----------

print('tfsdl-edp-supplychain-prod' in buckets_list)
print('tfsdl-edp-common-dims-prod' in buckets_list)
print('tfsdl-corp-crg-oracloud-test' in buckets_list)

# COMMAND ----------

# s3_bucket = 'tfsdl-edp-supplychain-prod'
# s3_bucket = 'tfsdl-edp-common-dims-prod'
# s3_bucket = 'tfsdl-psg-da-test'
s3_bucket = 'tfsdl-edp-sales-uat'
...
db_list = [i['Name'] for i in databaseList]
print(db_list)

# COMMAND ----------

'tfsdl_edp_common_dims' in db_list

# COMMAND ----------

'tfsdl_aig_qad_hist_delta' in db_list
