...
# MAGIC %sql
# MAGIC select * from d_product_plant limit 10;

# COMMAND ----------

# MAGIC %sql
# MAGIC select distinct src_sys_cd from d_product_plant;
...
# MAGIC 
# MAGIC SELECT 
# MAGIC   'd_product_plant' as table_name,
# MAGIC   'wf4s' as project_cntrl_tbl,
# MAGIC   src_sys_cd,
# MAGIC   'roc' as src_sys_cd_cntrl_tbl,
# MAGIC   count(*) as count_of_rows ,
...
# MAGIC where src_sys_cd like '%roc%' 
# MAGIC group by src_sys_cd
# MAGIC ;

# COMMAND ----------

[i for i in control_table_list if 'f_' in i['table_name']][0]

# COMMAND ----------

location = control_table_list[0]
bucket = 's3://tfsdl-edp-supplychain-prod/'
prefix = "processed/"
# table = location["table_name"] 
table='f_purchase_order'
single_table=table
list_of_tables=[]
list_of_tables.append(prefix + single_table+'/')
src_sys_cd_cntrl_tbl='gbl'
table_name_cntrl_tbl=location["table_name"]
project_cntrl_tbl='gbl'
search_like_src_sys_cd="%"+src_sys_cd_cntrl_tbl+"%"
...
# MAGIC %sql 
# MAGIC select * from f_purchase_order limit 10;

# COMMAND ----------

# MAGIC %sql
# MAGIC select distinct src_sys_cd from f_purchase_order;
...
# MAGIC %sql 
# MAGIC select distinct po_qty, length(cast(po_qty as string)) as len_ from f_purchase_order order by len_ desc limit 100;
